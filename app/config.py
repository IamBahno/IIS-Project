...
class Config:
    ...
    SQLALCHEMY_DATABASE_URI = "postgresql://iis_db_rtcs_user:kqocFyPlMauSrya5Xtkt46wGvwkKxMpZ@dpg-cliachnjc5ks73erj3m0-a.frankfurt-postgres.render.com/iis_db_rtcs"
